function Footer() {
  return (
    <div className="Footer">
      <a className="Footer--first-link">Questions? Contact us.</a>
      <div className="Footer-grid">
        <div className="Footer--grid-items">
          <a className="Footer--middle-links">FAQ</a>
          <a className="Footer--middle-links">Investor Relations</a>
          <a className="Footer--middle-links">Privacy</a>
          <a className="Footer--middle-links">Speed Test</a>
        </div>
        <div className="Footer--grid-items">
          <a className="Footer--middle-links">Help Center</a>
          <a className="Footer--middle-links">Jobs</a>
      ...
      <a className="Footer--last-link">Questions? Contact us.</a>© 2023 Gabriel
      Ahiamata.
    </div>
  );
}
